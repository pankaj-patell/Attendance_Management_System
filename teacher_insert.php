<?php
	...
	if($result>0)
	{
		...
		echo "<script>window.location.assign('add_teacher.php?msg=Data Inserted')</script>";
	}
	else{
		//echo "not inserted";
		echo mysqli_error($con);
		echo "<script>window.location.assign('add_teacher.php?msg=Data not Inserted')</script>";
